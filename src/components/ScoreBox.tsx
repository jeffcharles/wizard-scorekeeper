  ...
  render() {
    return (
      <div style={{display: 'flex', minWidth: 85}}>
        <div style={{alignItems: 'center', border: border, boxSizing: 'border-box', display: 'flex', justifyContent: 'center', whiteSpace: 'pre-wrap', width: '50%'}}>{this.props.score !== null ? this.props.score : ' '}</div>
